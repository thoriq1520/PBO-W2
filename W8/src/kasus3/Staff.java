...
public class Staff {
	...
	public Staff() {
		...
		staffList[6] = new Comission("Jordan", "007 Fire Lake", "555-7865", "007-51-8890", 6.25, 0.2);
		staffList[7] = new Comission("Mike", "721 Water Seven", "555-1004", "007-23-1923", 9.75, 0.15);
		
		((Executive)staffList[0]).awardBonus(500.00);
		((Hourly)staffList[3]).addHours(40);
		
		//penambahan hour dan sales Jordan
		((Comission)staffList[6]).addHours(35);
		((Comission)staffList[6]).addSales(4000);
		
		//penambahan hour dan sales Mike
